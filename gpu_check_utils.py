...
def check_nvidia_driver() -> tuple[bool, dict[str, Any]]:
    """
...
def check_pytorch_cuda() -> tuple[bool, dict[str, Any]]:
    """
...
def check_gpu_comprehensive() -> dict[str, Any]:
    """
    ...
    result["nvidia_driver"] = {"available": nvidia_available, **nvidia_info}

    # Check PyTorch CUDA
    pytorch_available, pytorch_info = check_pytorch_cuda()
    result["pytorch_cuda"] = {"available": pytorch_available, **pytorch_info}
    ...
    if nvidia_available and pytorch_available:
        ...
        result["recommendations"].append(
            "PyTorch CUDA support not available. Consider reinstalling PyTorch with CUDA."
        )
    elif not nvidia_available:
        result["overall_status"] = "not_available"
        result["recommendations"].append(
            "NVIDIA driver not detected. GPU acceleration will not be available."
        )
