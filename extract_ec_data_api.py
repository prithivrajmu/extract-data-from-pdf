...
def submit_pdf_to_datalab(pdf_path: str, api_key: str, output_format: str = 'markdown') -> dict:
    """
...
def poll_datalab_status(check_url: str, api_key: str, max_polls: int = 300, poll_interval: int = 2) -> dict:
    """
...
def extract_text_from_pdf_datalab_api(pdf_path: str, api_key: str) -> tuple:
    ...
    try:
        ...
        initial_response = submit_pdf_to_datalab(pdf_path, api_key, output_format='markdown')
...
def main():
    ...
    api_key = (
        os.environ.get('DATALAB_API_KEY') or 
        os.environ.get('DATALAB_API_TOKEN')
    )
    ...
    if api_key:
        ...
        print("   📖 Documentation: https://documentation.datalab.to/docs/recipes/marker/conversion-api-overview")
