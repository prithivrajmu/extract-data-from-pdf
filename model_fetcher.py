    ...
    try:
        ...
        for item in data:
            ...
            model_info = {
                ...
                'verified': item.get('gated', False) or model_id.startswith(('microsoft/', 'google/', 'datalab-to/'))
            }
...
def get_available_local_models(api_key: Optional[str] = None, use_cache: bool = True) -> List[Dict[str, str]]:
    """
